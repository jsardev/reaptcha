...
class Reaptcha extends Component<Props, State> {
  ...
  // @see: https://stackoverflow.com/questions/43488605/detect-when-challenge-window-is-closed-for-google-recaptcha
  _addCloseListener = (): void => {
    ...
    frames.forEach(frame => {
      if (frame.src.indexOf('google.com/recaptcha/api2/bframe') !== -1) {
        recaptchaWindow = frame.parentNode.parentNode;
      }
    });
      ...
      if (this.state.ready && this.container) {
        ...
        this.setState(
          ...
          () => {
            ...
            if (this.state.invisible && this.props.onClose) {
